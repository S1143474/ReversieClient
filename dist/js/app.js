...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var es6_promise_dist_es6_promise_auto_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(es6_promise_dist_es6_promise_auto_js__WEBPACK_IMPORTED_MODULE_0__);
      /* harmony import */
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _XhrHttpClient__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Loggers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _ILogger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _WebSocketTransport__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(24); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _Utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _TextMessageFormat__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14); // Copyright (c) .NET Foundation. All rights reserved.
      // Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
var Game = (url => {
  ...
  var privateInit = afterInit => {
    ...
    Game.Reversi.init(); // Setup the listeners for 2FA input

    _initPasswordAnd2FaClick(); // Set up the socket listeners which communicate with the reversi server.


    _initSignalRHubListeners(); // Set the page location data for 2FA page and register page


    _initLocationForDedicatedPages(); // Show password eye


    _initPasswordToggleShow(); // Setup the custom password strength meter and listener


    _initPasswordStrengthMeter(); // Listens to the buttons for deleting players (Moderator)


    _initModerateUserPageButtons(); // Initialize Stats module
  ...
  var _initLocationForDedicatedPages = () => {
  ...
  var _initPasswordStrengthMeter = () => {
  ...
  var _initModerateUserPageButtons = () => {
...
Game.API = (() => {
  ...
  var getRandomDadJoke = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(function* () {
      try {
        return yield Game.Data.get("https://icanhazdadjoke.com/");
      } catch (error) {
  ...
  var getRandomImage = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(function* (imageElement) {
      ...
      try {
        ...
        debugger;
        var isBase64 = base64regex.test(base64EncodedStr);
      ...
      } // let randomCategory = configMap.imageCategories[Math.floor(Math.random()*configMap.imageCategories.length)];
      // console.log(randomCategory);
      // let imageSrc = await Game.Data.getImage(`https://api.api-ninjas.com/v1/randomimage?category=${randomCategory}`);
      // var base64regex = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/;
      // var base64EncodedStr = imageSrc.toString('base64');
...
Game.Data = (() => {
  ...
  var privateInit = environment => {
    console.log("Data: Init with environment: ".concat(environment));
    ...
    start();
    if (stateMap.environment != 'production' && environment != 'development') throw new Error('De environment welke gebruikt dient te worden bestaat niet.');
